...
from ...parser.const import STR_TO_OBJ, OBJ_TO_STR
...
class TOML(ISerializer):
    ...
    def adapt_object_dict(self, obj: Any) -> Any:
        ...
        elif object_type in OBJ_TO_STR:
            return {
                OBJ_TO_STR[object_type]: str(obj)
            }
    ...
    def restore_object_dict(self, obj: Any) -> Any:
        ...
        if object_type is dict:
            if len(obj.keys()) == 1:
                ...
                if key == "None":
                    return None
                elif key in STR_TO_OBJ:
                    return STR_TO_OBJ[key](value)
